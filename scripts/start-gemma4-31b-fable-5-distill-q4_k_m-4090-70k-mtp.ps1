...
param(
    [int]$Port = 8083,
    [ValidateRange(1, 1000000)][int]$ContextSize = 70000,
...
$target = Join-Path $workspace 'models\Gemma-4-31B-Fable-5-Distill.q4_k_m.gguf'
...
if (-not (Test-Path -LiteralPath $target -PathType Leaf)) {
    throw "The copied TeichAI Fable-5 Q4_K_M target is missing: $target"
}
...
$alias = "gemma4-31b-fable-5-distill-q4km-70k-$mode"
